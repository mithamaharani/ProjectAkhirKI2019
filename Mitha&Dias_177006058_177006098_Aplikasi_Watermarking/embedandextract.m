...
%         figure,imshow(I1);
        ...
        [x2,y2]=find(amp1==255);     %%Ƕ��λ�õĸ���Ҷֱ������ϵ����
        A1=[x2,y2];
        ...
        for i=1:sizeA
            ...
            WT4=WT3(B(i,1),B(i,2)); 
            FF2(A(i,1)+x,A(i,2)+y)=(1+alpha*WT4)*F2(A(i,1)+x,A(i,2)+y);%%%����Ҷ�Գ��Ա�֤������Ҷ�任��Ϊʵ��
...
%                     disp(['Angle Rotation: ' num2str(angle)]);
            ...
            [x2,y2]=find(amp1a==255);     %%Ƕ��λ�õĸ���Ҷֱ������ϵ����
            A1a=[x2,y2];
            A11a=A1a(:,1)-xa;
            A12a=A1a(:,2)-ya;
            Aa=[A11a,A12a];
            ...
            rk=zeros(Ma-M+1,Na-N+1);      %%%��ģ����������������ȷ��ˮӡλ��
            for i=1:Ma-M+1
                for j=1:Na-N+1
